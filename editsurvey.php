			...
			<div class="tab-content" id="myTabContent">
			  <div class="tab-pane fade show active" id="questions" role="tabpanel" aria-labelledby="questions-tab">
					...
					<div class="pt-new-survey-det">
						...
						<div class="pt-form-i">
							<span class="pt-icon"><i class="fas fa-user"></i></span>
							<select class="selectpicker" name="survey_oficio" id="survey_oficio" required>
								<option value=""><?=$lang['new']['oficio2']?></option>
						...
						<div class="form-inline">
							...
							<div class="form-group">
								...
								<select name="button_border_style">
									...
									<option value="solid"<?=($rs['button_border_style'] == 'solid'?' selected':'')?>>Sólido</option>
									<option value="dotted"<?=($rs['button_border_style'] == 'dotted'?' selected':'')?>>Punteado</option>
									<option value="dashed"<?=($rs['button_border_style'] == 'dashed'?' selected':'')?>>LinSpace</option>
								</select>
							</div>
							<div class="form-group">
		...
		<div class="col-6">
			...
			<div class="pt-survey">
				...
				<div class="pt-link">
					<button class="fancy-button bg-gradient1 step-link">
						<span>
							<?=($rs['thanks_btn'] ? $rs['thanks_btn'] : 'Finalizar')?>
