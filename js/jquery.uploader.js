    ...
    (function($){
        ...
        ImageUploader.prototype = {
            ...
            uploadFailed: function () {
                ...
                this.currentThumbnail = null;
                this.options.error('subida fallida');
                this.uploadNextFile();
            },
            ...
            uploadCanceled: function () {
                this.canUpload = true;
                this.currentThumbnail = null;
                this.options.error('carga cancelada');
                this.uploadNextFile();
            },
                ...
                if (this.fileApiSupported()) {
                    ...
                    for (var i=0; i < files.length; i++) {
                        if (this.options.maxFileSize > 0 && file.size > this.options.maxFileSize) {
                            return this.options.error('el archivo que está intentando cargar es demasiado grande');
                        } else if (!this.options.allowDuplicate && this.fileAlreadyUploaded(files[i])) {
                            return this.options.error('el archivo que está intentando cargar ya ha sido enviado');
                        } else {
                   ...
                   alert('archivos api no compatibles');
               }
            },
