...
$(".pt-add-answer-link").livequery("click", function(){
	...
	if(slct.val() == "input" || slct.val() == "email" || slct.val() == "date"){
		...
		appnd += '<select class="selectpicker"><option data-icon="flag-icon flag-icon-pe" value="PE"> (+51)</option></select>';
		appnd += '<input type="phone" role="answer['+anid+'][name]" placeholder="939-488-507">';
