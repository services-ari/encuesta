...
# Si el archivo de instalación existe
...
# Incluyendo archivos de configuración
...
# Información del cliente del usuario
...
if(in_array(page, ['configs', 'login'])){
  header("HTTP/1.0 404 Pagina no encontrada");
}
...
# Aplicación de inicio de sesión de Facebook
...
# Aplicación de inicio de sesión de Twitter
...
# Aplicación de inicio de sesión de Google
...
# Configuración de Paypal Payement Gateway
