...
<div class="pt-wrapper">
	<div class="pt-admin-nav">
		<div class="pt-logo"><i class="fas fa-user-secret"></i></div>
		<ul>
							...
							<li>
								<div class="media">
									...
									<div class="media-body">
										<?=fh_user($rs['id'])?> <p style="display: inline-block;">(<?=fl_user($rs['id'])?>)</p><br>
		...
		<div class="pt-plans">
			<form class="pt-sendplans">
				<div class="pt-body mb-3">
						...
						<label>Opción planes desactivados</label>
				</div>
				<div class="row">
					<?php
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <h4 class="modal-title">Enviar encuesta por email</h4>
	      ...
	      <div class="modal-body">
					<div class="mb-3">
						<input type="text" name="subject" value="" placeholder="Asunto">
					</div>
					<div class="mb-3">
					...
					<div class="">
						<textarea name="message" id="wysibb-editor3">[img width=244 height=58]https://multiserviciosari.com/wp-content/uploads/2020/08/Logo.png.webp[/img]
[hr]
[color=#666666][size=3]Hola,[/size][/color]
[color=#666666][size=3][font=Arial, Helvetica, sans-serif]Nos complace enviarle esta encuesta para que nos brinde su opinión honesta sobre [/font][/size][/color][b][color=#666666][size=3][font=Arial, Helvetica, sans-serif]{title}.[/font][/size][/color][/b]

[color=#666666][size=3][font=Arial, Helvetica, sans-serif]{button bg=#4CAF50}Iniciar la encuesta[/font][/size][/color][color=#666666][color=#666666][size=3][font=Arial, Helvetica, sans-serif][size=3][font=Arial, Helvetica, sans-serif]{/button}[/font][/size][/font][/size][/color][/color]

[color=#abadae][size=2][font=Arial, Helvetica, sans-serif]© Multiservicios ari 2021[/font][/size][/color]</textarea>
					</div>
	      </div>
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th scope="col"><?=$lang['dashboard']['u_oficio']?></th>
		...
		<?php elseif($pg == "setting"): ?>
			<div class="pt-body">
				...
				<div class="pt-admin-setting">
					...
					<h3 class="cp-form-title" hidden>Compartir en Facebook</h3>
					...
					<p hidden><i class="fas fa-exclamation-triangle"></i> URL redireccionamiento: <b><?=path?>/login-facebook.php</b></p>

					<h3 class="cp-form-title" hidden>Compartir en Twitter</h3>
					<div class="form-group" hidden>
					...
					<p hidden><i class="fas fa-exclamation-triangle"></i> URL redireccionamiento: <b><?=path?>/login-twitter.php</b></p>

					<h3 class="cp-form-title" hidden>Compartir en Google</h3>
					<div class="form-group" hidden>
					...
					<p hidden><i class="fas fa-exclamation-triangle"></i> URL redireccionamiento: <b><?=path?>/login-google.php</b></p>

					<h3 class="cp-form-title" hidden>Paypal</h3>
					<div class="form-group" hidden>
